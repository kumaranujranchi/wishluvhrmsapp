...
// 3. Fetch Attendance for the date (Select employee_id first for FETCH_UNIQUE)
$sql_attendance = "SELECT employee_id, status, clock_in, clock_out, total_hours FROM attendance WHERE date = :date";
...
<body>
    ...
    <div class="report-wrapper">
        ...
        <div class="footer-note">
            Generated from MyWold HRMS | Printed On:
            <?= date('d/m/Y H:i') ?>
        </div>
    </div>
