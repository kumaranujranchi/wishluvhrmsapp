            ...
            <table class="table">
                ...
                <tbody>
                    <?php if (empty($requests)): ?>
                        <tr>
                            <td colspan="5" style="text-align: center; padding: 3rem; color: #94a3b8;">No pending requests
                                from your team.</td>
                        </tr>
                    <?php else: ?>
                                    ...
                                    <div style="display: flex; align-items: center; gap: 0.75rem;">
                                        ...
                                        <div>
                                            ...
                                            <div style="font-size: 0.75rem; color: #64748b;">
                                                <?= htmlspecialchars($req['dept_name']) ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div style="font-weight: 500; font-size: 0.9rem;">
                                        ...
                                        <?= date('d M', strtotime($req['end_date'])) ?></div>
                                </td>
                                <td>
                                    <div style="font-size: 0.85rem; font-weight: 600; color: #4f46e5;"><?= $req['leave_type'] ?>
                                    </div>
                                    <div style="font-size: 0.8rem; color: #64748b; margin-top: 4px; max-width: 250px;">
                                        <?= htmlspecialchars($req['reason']) ?></div>
                                </td>
                                <td>
                                    <?php
